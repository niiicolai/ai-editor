# Introduction
The project contains seven services designed to handle authentication, payment, LLM communication, email, vector embeddings, and RAG evaluation. Additionally, it includes two clients: a website designed for showcasing the product, managing purchases, user profiles, and more; and an IDE that integrates a chat module with an AI assistant capable of reading and listing files in the open directory, as well as accessing autogenerated QA information provided by a RAG.
