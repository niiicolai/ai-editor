...
const API_URL = import.meta.env.VITE_EMAIL_API;
if (!API_URL) console.error('CONFIGURATION ERROR(emailTransactionService.ts): VITE_EMAIL_API should be set in the .env file');
