    ...
    <div className="bg-white">
      ...
      <div className="relative bg-indigo-800 overflow-hidden flex gap-3">
            ...
            <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
              <div className="sm:text-center lg:text-left">
                <h1 className="text-4xl tracking-tight font-extrabold text-white sm:text-5xl md:text-6xl">
                  <span className="block">AI-Powered Code Editor</span>
                  <span className="block text-indigo-200">for Modern Developers</span>
                </h1>
                <p className="mt-3 text-base text-indigo-100 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
                  Experience the future of coding with our intelligent editor. Get real-time suggestions, automated refactoring, and AI-powered code completion that understands your context.
                </p>
        ...
        <div className="p-12">
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-t from-indigo-800 to-transparent opacity-50"></div>
        </div>
      </div>
          ...
          <div className="mt-10">
            <div className="space-y-10 md:space-y-0 md:grid md:grid-cols-2 md:gap-x-8 md:gap-y-10">
              ...
              <div className="relative">
                ...
                <div className="ml-16">
                  <h3 className="text-lg leading-6 font-medium text-gray-900">Intelligent Code Completion</h3>
              ...
              <div className="relative">
                ...
                <div className="ml-16">
                  <h3 className="text-lg leading-6 font-medium text-gray-900">Real-time Refactoring</h3>
                  <p className="mt-2 text-base text-gray-500">
              ...
              <div className="relative">
                ...
                <div className="ml-16">
                  <h3 className="text-lg leading-6 font-medium text-gray-900">Smart Debugging</h3>
                  <p className="mt-2 text-base text-gray-500">
      ...
      <div className="bg-indigo-50">
        <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8 lg:flex lg:items-center lg:justify-between">
          <h2 className="text-3xl font-extrabold tracking-tight text-gray-900 sm:text-4xl">
            <span className="block">Ready to experience the future of coding?</span>
            <span className="block text-indigo-600">Start coding with AI today.</span>
          </h2>
