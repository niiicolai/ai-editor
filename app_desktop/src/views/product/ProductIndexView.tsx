      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center">
          ...
          <p className="mt-3 max-w-2xl mx-auto text-xl text-gray-500 sm:mt-4">
            Select the perfect credit package for your job search needs
          </p>
        </div>
              ...
              <div className="pt-6 pb-8 px-6">
                ...
                <ul className="mt-6 space-y-4">
                  <li className="flex space-x-3">
                    ...
                    <span className="text-sm text-gray-500">{product.noOfCredits} AI-powered job applications</span>
                  </li>
                  <li className="flex space-x-3">
                    <svg className="flex-shrink-0 h-5 w-5 text-green-500" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                      <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                    </svg>
                    <span className="text-sm text-gray-500">Priority job matching</span>
                  </li>
                  <li className="flex space-x-3">
                    <svg className="flex-shrink-0 h-5 w-5 text-green-500" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                      <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                    </svg>
                    <span className="text-sm text-gray-500">Advanced resume optimization</span>
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div className="mt-12 max-w-3xl mx-auto divide-y divide-gray-200">
            <dl className="mt-6 space-y-6 divide-y divide-gray-200">
              <div className="pt-6">
                <dt className="text-lg">
                  <button className="text-left w-full flex justify-between items-start text-gray-400">
                    <span className="font-medium text-gray-900">How do credits work?</span>
                ...
                <dd className="mt-2 pr-12">
                  <p className="text-base text-gray-500">
                    Each credit allows our AI to submit one job application on your behalf. The AI will match your skills and preferences with job requirements and submit a tailored application.
                  </p>
                </dd>
              </div>
              ...
              <div className="pt-6">
                ...
                <dd className="mt-2 pr-12">
                  <p className="text-base text-gray-500">
                    We offer a 30-day money-back guarantee for unused credits. Once credits are used for job applications, they cannot be refunded.
                  </p>
                </dd>
              </div>
            </dl>
