...
function CreditInfoComponent(props: { progressOnly: boolean }) {
    ...
    return (
        <>
            <div className="space-y-4">
                ...
                {/* Credit Stats */}
                <div className={`grid grid-cols-3 gap-4 ${props.progressOnly ? 'hidden' : ''}`}>
                ...
                {/* Usage Info */}
                <div className={`text-xs text-gray-500 italic ${props.progressOnly ? 'hidden' : ''}`}>
                    {!creditInfo?.creditsLeft ? (
